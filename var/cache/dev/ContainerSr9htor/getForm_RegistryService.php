...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AvisType' => function () {
...
}, 'AppBundle\\Form\\CategorieType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\CategorieType']) ? $this->services['AppBundle\Form\CategorieType'] : ($this->services['AppBundle\Form\CategorieType'] = new \AppBundle\Form\CategorieType())) && false ?: '_'};
